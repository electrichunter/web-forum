...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         <a href="edit_post.php?id=<?= $post_id; ?>" class="inline-option-btn">düzenle</a>
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('delete this post?');">sil</button>
         <a href="view_posts.php" class="inline-option-btn">geri dön</a>
      </div>
   </form>
   <?php
         }
...
<section class="comments" style="padding-top: 0;">
   ...
   <p class="comment-title">yorumlar</p>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('delete this comment?');">sil</button>
      </form>
   </div>
   <?php
         }
