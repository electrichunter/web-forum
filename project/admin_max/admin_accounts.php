...
<section class="accounts">
   ...
   <h1 class="heading">yazar giriş</h1>

   <div class="box-container">

   <div class="box" style="order: -2;">
      <p>Yeni yazar kaydet</p>
      <a href="register_admin.php" class="option-btn" style="margin-bottom: .5rem;">yeni kayıt</a>
   </div>
   ...
   <div class="box" style="order: <?php if($fetch_accounts['id'] == $admin_id){ echo '-1'; } ?>;">
      <p> yazar id : <span><?= $fetch_accounts['id']; ?></span> </p>
      <p> kullanıcı adı : <span><?= $fetch_accounts['name']; ?></span> </p>
      <p> toplam yazı : <span><?= $total_admin_posts; ?></span> </p>
      <div class="flex-btn">
         <?php
         ...
         ?>
            ...
            <form action="" method="POST">
               ...
               <button type="submit" name="delete"onclick="return confirm('delete the account?');" class="delete-btn" style="margin-bottom: .5rem;">sil</button>
            </form>
         <?php
            }
         ?>
